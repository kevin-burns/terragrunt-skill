...
terraform {
  ...
  # Examples:
  # Local module:
  #   source = "${dirname(find_in_parent_folders("root.hcl"))}/modules/[MODULE_NAME]"
  #   (get_repo_root() also works, but only when the git root is the infra root and
  #    configs run from a real clone — it breaks in subtree/artifact CI checkouts)
  # Git repository:
