...
|---|---|---|---|
| `error-patterns.md` | diagnosed errors: likely causes for every one, a fix for 36 | 69 | `^## ERROR:` |
...
- `references/error-patterns.md` — 69 diagnosed errors. Every one names likely causes; **36
